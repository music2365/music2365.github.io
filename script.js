...
const songs = [
  ...
  // TOP 100 SONGS
  {title: "Blinding Lights", artist: "The Weekend", src: "music/example.mp3"},
  {title: "Shape of You", artist: "Ed Sheeran", src: "music/example.mp3"},
  {title: "Sweater Weather", artist: "The Neighbourhood", src: "music/example.mp3"},
  {title: "Starboy", artist: "The Weekend, Draft Punk", src: "music/example.mp3"},
  {title: "As It Was", artist: "Harry Styles", src: "music/example.mp3"},
  {title: "Someone You Loved", artist: "Lewis Capaldi", src: "music/example.mp3"},
  {title: "Sunflower", artist: "Post Malone Swae Lee", src: "music/example.mp3"},
  {title: "One Dance", artist: "Drake, WizKid, Kala", src: "music/example.mp3"},
  {title: "Perfect", artist: "Ed Sheeran", src: "music/example.mp3"},
  {title: "Airplane", artist: "Nick Phoenix", src: "music/example.mp3"},
